...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!permissions.has("CONNECT")) return message.channel.send(i18n.__("common.missingPermissionConnect"));

    if (!permissions.has("SPEAK")) return message.channel.send(i18n.__("common.missingPermissionSpeak"));
